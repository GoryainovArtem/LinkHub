# Generated by Django 4.1.7 on 2023-04-19 20:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_created_project', models.BooleanField(choices=[(True, 'Да'), (False, 'Нет')], default=False, verbose_name='Проект создан этим автором?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links', to='links.head', verbose_name='Раздел')),
            ],
            options={
                'verbose_name': 'Ссылка',
